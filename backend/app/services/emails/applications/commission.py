...
@celery.task
def acomplish_email(to_name: str, to_lname: str, observation: str , files: list[Dict[str, Any]], email: list[str]):
    ...
    for jfile in files:
        ...
        obj = s3.get_data_from_s3_bucket(settings.aws_bucket_name, jfile['path'])
