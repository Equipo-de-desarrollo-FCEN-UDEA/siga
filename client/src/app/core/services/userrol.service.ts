...
import { UserRolInDBase, UserRolResponse } from '@interfaces/userrol';
...
export class UserRolService {
  ...
  // service for get all the roles of an user
  getUserRoles(id: number = 0): Observable<UserRolResponse[]> {
    return this.http.get<UserRolResponse[]>(this.urlEndpoint + id);
  }
