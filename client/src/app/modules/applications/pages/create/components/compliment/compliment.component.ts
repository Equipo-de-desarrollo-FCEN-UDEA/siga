...
export class ComplimentComponent implements OnInit {
  ...
  correosPredeterminados: any = [
    ...
    {
      nombre: 'Fondo de Pasajes Internacionales',
      value: 'dandrea.torres@udea.edu.co',
    },
    {
      nombre: 'Vicerrectoría de Investigación',
      value: 'david.torresg@udea.edu.co',
    },
    {
      nombre: 'Centro de Investigaciones SIU',
      value: 'david.torresg@udea.edu.co',
    },
    {
      nombre: 'Fondos de Vicerrectoría de Docencia',
      value: 'david.torresg@udea.edu.co',
    },
  ];
